...
I do the tiling and workspace management inside Emacs or tmux. I would get minimal additional benefit out of tiling wm.
The only things I use from the window manager layer:
...
On top of the current setup, personally, I just run: chromium, (Termite + tmux + zsh), Emacs (a lot of things in it) and [[https://github.com/kozikow/keyremaplinux][my keyboard layout]].
* Additional links
