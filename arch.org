...
#+BEGIN_SRC bash :results output
  ...
  reboot
#+END_SRC
** (optional) Install window manager
...
pacman -Rc gnome-keyring gnome-contacts gnome-calculator empathy gnome-terminal gnome-online-accounts
#+END_SRC
...
#+END_EXAMPLE
****** TODO It sometimes doesn't work
I don't know systemd well. It sometimes does not run at startup and I need to do it manually.
***** Recomended values
...
It took me a few days to adjust, but now it's much more efficient and I am considering even increasing it.
*** Graphics
