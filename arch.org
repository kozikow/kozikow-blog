...
Mass installing "gnome" package is against arch philosophy
and if you have extra time you should go for picking packages 
you need. If you want an easy way out you can just:
#+BEGIN_SRC bash :results output
