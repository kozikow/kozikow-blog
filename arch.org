...
#+OPTIONS: toc:3
#+OPTIONS: todo:t
#+TITLE: Installing and configuring Arch Linux on Thinkpad X1 Carbon (gen 4)
#+DATE: <2016-06-04 Sat>
...
I got close to the 100% of laptop functionality working on the Arch Linux. Setup should be very similar on modern laptops with GPT/UEFI.

Even if Arch wiki is very comprehensive, it needs reading to decide what is right for the particular hardware and use case.
You may find interesting what people chose in the similar situation.
Dual booting with windows and UEFI/GPT are not as well documented as the plain old linux installations.

[[https://raw.githubusercontent.com/kozikow/kozikow-blog/master/arch.org][This post was written in and is readable in the Emacs org mode format]]. It's also source controled in the org format.
* Why Arch Linux?
...
#+END_SRC
[[https://wiki.archlinux.org/index.php/netctl#Problems_with_netctl-auto_on_resume][Rather than call this manually you can automate it with systemd]]
** Screen lock
