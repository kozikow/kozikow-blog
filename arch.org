...
I also got some warnings about some missing hardware.
Strangely the problem somehow resolved itself.
Probably the modules got pulled by something like xorg after I enabled AUR (extended repository of packages).
