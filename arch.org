...
Mirroring displays works as expected.
**** Sound
...
I tried to bind it from the console, but custom shortcuts via =gsettings set= are more complicated than just predefined keybindings.
