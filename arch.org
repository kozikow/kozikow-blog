...
I recommend US locale, since many programs support it better, while you don't get much benefit from GB locale even in UK.

Also, if you install gnome, it stores it's own locale settings.
