...
** Screen lock
I just wanted to show arch image as a wallpaper and it took me a bit.
#+BEGIN_SRC bash :results output
  pacman -S xscreensaver
  xscreensaver-demo # configure
  # http://askubuntu.com/questions/74200/how-do-i-use-a-photos-directory-as-my-screensaver
  # to lock screen
