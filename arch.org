...
eDP-1 connected primary 2560x1440+0+0 (normal left inverted right x axis y axis) 310mm x 174mm
   ...
   ...
#+END_EXAMPLE
**** Some applications had problems with HiDPI
[[https://wiki.archlinux.org/index.php/HiDPI][If you have any more problems with HiDPI read through Arch wiki sections.]]
Majority of applications 
(gnome applications, chromium, emacs, termite)
correctly handled HiDPI screen.
Some apps, like xscreensaver or xterm were displaying very small
windows not adapted to HiDPI.
*** Sound
