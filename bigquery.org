...
To run a query go to [[https://bigquery.cloud.google.com/dataset/bigquery-public-data:github_repos][big query console]] and click "Compose Query".
...
It required a couple of big query tricks to make it work
