...
#+END_SRC
* How I use it
- Start emacs and call =my-join-irc=.
- I browse through different channels and go back to what I was doing before =C-x r j 8=.
- When I want to open IRC again I call a function that saves my work under 8 and opens irc:
  #+BEGIN_SRC clojure :results output
    (defun my-open-irc ()
      (interactive)
      (window-configuration-to-register ?8)
      (jump-to-register ?9))
  #+END_SRC
- Go back to work with =C-x r j 8=.
