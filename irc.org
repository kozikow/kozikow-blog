...
* Introduction
I've set up an Emacs function =my-open-irc= that connects to all IRC channels I am interested in
...
It lets me to quickly check out the IRC and go back to what I was doing before.
Calling the =my-open-irc= again will just display the saved layout.
Optionally, I also provided an elisp to re-connect if an ERC lost connection, that you can add to =my-open-irc=.
[[https://www.emacswiki.org/emacs/WindowsAndRegisters][See documentation about window-configuration-to-register]].
...
Someone recommended https://gist.github.com/sg2002/c3dca176be521c743fc03846a033b008 on #emacs.
* How I use it
- Start emacs and call =my-open-irc=. It opens 2x2 layout with 4 irc chanels.
- Go back to old windows using =C-x r j 8=.
- Calling =my-open-irc= opens the same 2x2 windows layout and saves current layout under =C-x r j 8=.
