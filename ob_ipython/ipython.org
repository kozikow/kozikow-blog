...
** Results can be exported to many formats, like latex [[https://github.com/kozikow/kozikow-blog/blob/master/ob_ipython/ipython.pdf][(demo)]] 
...
All code examples have been written in org mode.
